...
var _rajasharan$elm_freehand_drawing$Main$urlHashParser = function (location) {
	return location.hash;
};
var _rajasharan$elm_freehand_drawing$Main$nop = _elm_lang$core$Platform_Cmd$none;
var _rajasharan$elm_freehand_drawing$Main$urlUpdate = F2(
	function (hash, model) {
		return {
			ctor: '_Tuple2',
...
var _rajasharan$elm_freehand_drawing$Main$init = function (hash) {
	return {
		ctor: '_Tuple2',
		_0: {
			shape: _elm_lang$core$Native_List.fromArray(
...
var _rajasharan$elm_freehand_drawing$Main$main = {
	main: A2(
		...
		_elm_lang$navigation$Navigation$makeParser(_rajasharan$elm_freehand_drawing$Main$urlHashParser),
		{init: _rajasharan$elm_freehand_drawing$Main$init, update: _rajasharan$elm_freehand_drawing$Main$update, subscriptions: _rajasharan$elm_freehand_drawing$Main$subs, view: _rajasharan$elm_freehand_drawing$Main$view, urlUpdate: _rajasharan$elm_freehand_drawing$Main$urlUpdate})
};
