...
var _rajasharan$elm_freehand_drawing$Decoders$point = A2(
	_elm_lang$core$Json_Decode$andThen,
	_elm_lang$core$Json_Decode$string,
	function (s) {
		var _p2 = s;
...
var _rajasharan$elm_freehand_drawing$Decoders$initial = A2(
	_elm_lang$core$Json_Decode$andThen,
	_elm_lang$core$Json_Decode$string,
	function (s) {
		var _p3 = s;
		...
		_elm_lang$core$Json_Decode$oneOf(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(_elm_lang$core$Json_Decode_ops[':='], 'kind', _rajasharan$elm_freehand_drawing$Decoders$initial),
					...
					_rajasharan$elm_freehand_drawing$Types$SocketMsg,
					A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
					A2(_elm_lang$core$Json_Decode_ops[':='], 'kind', _rajasharan$elm_freehand_drawing$Decoders$point),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('canvas'),
						A3(
						_elm_lang$html$Html_Events$onWithOptions,
						'touchstart',
