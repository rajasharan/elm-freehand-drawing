...
var _rajasharan$elm_freehand_drawing$Types$Model = F6(
	function (a, b, c, d, e, f) {
		return {id: a, shape: b, size: c, moving: d, server: e, clients: f};
	});
...
var _rajasharan$elm_freehand_drawing$Types$TouchEnd = {ctor: 'TouchEnd'};
var _rajasharan$elm_freehand_drawing$Types$TouchStart = {ctor: 'TouchStart'};
var _rajasharan$elm_freehand_drawing$Types$TouchMove = function (a) {
	return {ctor: 'TouchMove', _0: a};
};
var _rajasharan$elm_freehand_drawing$Types$Error = function (a) {
...
var _rajasharan$elm_freehand_drawing$Utils$print = function (str) {
	...
	return _rajasharan$elm_freehand_drawing$Utils$nop;
};
var _rajasharan$elm_freehand_drawing$Utils$convertMouseToCanvasCoord = F2(
	function (pos, size) {
		var y = _elm_lang$core$Basics$toFloat(pos.y);
		var x = _elm_lang$core$Basics$toFloat(pos.x);
		var h = _elm_lang$core$Basics$toFloat(size.height);
		var y$ = 0 - (y - (h / 2));
		var w = _elm_lang$core$Basics$toFloat(size.width);
		var x$ = x - (w / 2);
...
var _rajasharan$elm_freehand_drawing$Utils$setSize = F2(
	function (size, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{size: size});
...
var _rajasharan$elm_freehand_drawing$Clients$addPointToClient = F4(
	function (id, x, y, model) {
		var point = A2(
			_rajasharan$elm_freehand_drawing$Utils$denormalizePoint,
			model.size,
...
var _rajasharan$elm_freehand_drawing$Clients$drawClient = F2(
	function (result, model) {
		var _p3 = result;
		if (_p3.ctor === 'Err') {
			var p = A2(_elm_lang$core$Debug$log, 'decode', _p3._0);
			return model;
		} else {
			return A2(_rajasharan$elm_freehand_drawing$Clients$drawClient$, _p3._0, model);
		}
	});

var _rajasharan$elm_freehand_drawing$Decoders$kindCancel = A2(
...
var _rajasharan$elm_freehand_drawing$Decoders$kindPoint = A2(
	_elm_lang$core$Json_Decode$andThen,
	_elm_lang$core$Json_Decode$string,
	function (s) {
		var _p1 = s;
...
var _rajasharan$elm_freehand_drawing$Decoders$kindInitial = A2(
	_elm_lang$core$Json_Decode$andThen,
	_elm_lang$core$Json_Decode$string,
	function (s) {
		var _p2 = s;
...
var _rajasharan$elm_freehand_drawing$Decoders$decodeSocketMsg = function (message) {
	return A3(
		...
		_elm_lang$core$Json_Decode$oneOf(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(_elm_lang$core$Json_Decode_ops[':='], 'kind', _rajasharan$elm_freehand_drawing$Decoders$kindInitial),
					...
					_rajasharan$elm_freehand_drawing$Types$SocketMsg,
					A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
					A2(_elm_lang$core$Json_Decode_ops[':='], 'kind', _rajasharan$elm_freehand_drawing$Decoders$kindPoint),
					...
					_rajasharan$elm_freehand_drawing$Types$SocketMsg,
					A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
					A2(_elm_lang$core$Json_Decode_ops[':='], 'kind', _rajasharan$elm_freehand_drawing$Decoders$kindCancel),
					_elm_lang$core$Json_Decode$succeed(0),
					_elm_lang$core$Json_Decode$succeed(0))
				])));
};
var _rajasharan$elm_freehand_drawing$Decoders$decodePoint = function (point) {
	var result = A2(
		_elm_lang$core$Json_Decode$decodeString,
		A3(
...
var _rajasharan$elm_freehand_drawing$Decoders$mouseStartDecoder = _rajasharan$elm_freehand_drawing$Decoders$touchStartDecoder;
var _rajasharan$elm_freehand_drawing$Decoders$mouseDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
...
var _rajasharan$elm_freehand_drawing$Decoders$touchDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['changedTouches', '0']),
...
var _rajasharan$elm_freehand_drawing$Decoders$touchMoveDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	_rajasharan$elm_freehand_drawing$Types$TouchMove,
	_rajasharan$elm_freehand_drawing$Decoders$positionDecoder(_rajasharan$elm_freehand_drawing$Types$Touch));
var _rajasharan$elm_freehand_drawing$Decoders$mouseMoveDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	_rajasharan$elm_freehand_drawing$Types$TouchMove,
	_rajasharan$elm_freehand_drawing$Decoders$positionDecoder(_rajasharan$elm_freehand_drawing$Types$Mouse));

var _rajasharan$elm_freehand_drawing$Encoders$encodeSocketMsg = function (msg) {
	var _p0 = msg.kind;
	switch (_p0.ctor) {
		case 'Initial':
			return A2(
				...
				_elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'kind',
							_1: _elm_lang$core$Json_Encode$string('initial')
						},
				...
				_elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'x',
							_1: _elm_lang$core$Json_Encode$float(msg.x)
						},
							{
							ctor: '_Tuple2',
							_0: 'y',
...
var _rajasharan$elm_freehand_drawing$Init$urlUpdate = F2(
	function (hash, model) {
		return {
			ctor: '_Tuple2',
...
var _rajasharan$elm_freehand_drawing$Init$urlHashParser = function (location) {
	return location.hash;
};
var _rajasharan$elm_freehand_drawing$Init$init = function (hash) {
	return {
		ctor: '_Tuple2',
		_0: {
			id: -1,
...
var _rajasharan$elm_freehand_drawing$Subscription$send = _elm_lang$websocket$WebSocket$send;
var _rajasharan$elm_freehand_drawing$Subscription$subs = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$window$Window$resizes(_rajasharan$elm_freehand_drawing$Types$Window),
				A2(_elm_lang$websocket$WebSocket$listen, model.server, _rajasharan$elm_freehand_drawing$Types$Listen)
			]));
};
...
var _rajasharan$elm_freehand_drawing$Update$sendPosition = F2(
	function (pos, m) {
		var normalizePoint$ = _rajasharan$elm_freehand_drawing$Utils$normalizePoint(m.size);
		var _p0 = normalizePoint$(
...
var _rajasharan$elm_freehand_drawing$Views$banner = function (model) {
	return _evancz$elm_graphics$Collage$toForm(
		A4(
			...
			model.size.height,
			A2(
				_evancz$elm_graphics$Element$midTopAt,
				_evancz$elm_graphics$Element$relative(0.5),
				_evancz$elm_graphics$Element$relative(1.0e-2)),
			_evancz$elm_graphics$Element$justified(
				A2(
					_evancz$elm_graphics$Text$line,
					_evancz$elm_graphics$Text$Under,
					A2(
						_evancz$elm_graphics$Text$height,
						40,
						_evancz$elm_graphics$Text$monospace(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_rajasharan$elm_freehand_drawing$Decoders$touchStartDecoder),
				A3(
				_elm_lang$html$Html_Events$onWithOptions,
				'touchmove',
				{stopPropagation: true, preventDefault: true},
...
var _rajasharan$elm_freehand_drawing$Views$view = function (model) {
	return _rajasharan$elm_freehand_drawing$Views$drawCanvas(model);
};

var _rajasharan$elm_freehand_drawing$Main$main = {
	main: A2(
		_elm_lang$navigation$Navigation$program,
		_elm_lang$navigation$Navigation$makeParser(_rajasharan$elm_freehand_drawing$Init$urlHashParser),
		{init: _rajasharan$elm_freehand_drawing$Init$init, update: _rajasharan$elm_freehand_drawing$Update$update, subscriptions: _rajasharan$elm_freehand_drawing$Subscription$subs, view: _rajasharan$elm_freehand_drawing$Views$view, urlUpdate: _rajasharan$elm_freehand_drawing$Init$urlUpdate})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _rajasharan$elm_freehand_drawing$Main$main === 'undefined' ? null : _rajasharan$elm_freehand_drawing$Main$main);
