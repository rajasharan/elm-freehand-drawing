...
var _rajasharan$elm_freehand_drawing$Types$Model = F4(
	function (a, b, c, d) {
...
var _rajasharan$elm_freehand_drawing$Decoders$positionDecoder = function (mouseType) {
	var converter = function (tuple) {
		var _p1 = tuple;
		return {
			x: _elm_lang$core$Basics$round(_p1._0),
			y: _elm_lang$core$Basics$round(_p1._1)
		};
	};
	var _p2 = mouseType;
	if (_p2.ctor === 'Mouse') {
...
var _rajasharan$elm_freehand_drawing$Update$sendCancel = function (m) {
	return A2(_rajasharan$elm_freehand_drawing$Subscription$send, m.server, 'Cancel');
};
var _rajasharan$elm_freehand_drawing$Update$sendPosition = F2(
	function (pos, m) {
		...
		return m.moving ? A2(
			...
			m.server,
			_elm_lang$core$Basics$toString(point)) : _rajasharan$elm_freehand_drawing$Utils$nop;
	});
var _rajasharan$elm_freehand_drawing$Update$addPointToShape = F2(
...
var _rajasharan$elm_freehand_drawing$Update$draw = F2(
	function (pos, model) {
		...
		return model.moving ? A2(_rajasharan$elm_freehand_drawing$Update$addPointToShape, point, model) : model;
	});
...
var _rajasharan$elm_freehand_drawing$Update$decodeAndAddShape = F2(
	function (str, m) {
		...
		if (_p1.ctor === 'Just') {
			return A2(
				_rajasharan$elm_freehand_drawing$Update$addPointToShape,
	...
	function (message, model) {
		...
		switch (_p2.ctor) {
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: A2(_rajasharan$elm_freehand_drawing$Update$decodeAndAddShape, _p2._0, model),
					_1: _rajasharan$elm_freehand_drawing$Utils$nop
				};
		}
	});
